                ...
                <div className="rounded-lg border p-4">
                  <div className="mb-2 flex items-center justify-between">
                    <div className="font-semibold">
                      {booking.listing?.title?.ar || `إعلان رقم #${booking.listing_id}`}
                    </div>
                  </div>
                  {booking.listing?.description?.ar && (
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            <span className="font-medium">{booking.adults_count} بالغين</span>
                            {booking.children_count > 0 && (
                              <span className="text-muted-foreground">
                                {" "}
                                • {booking.children_count} أطفال
                              </span>
                            )}
                            {booking.infants_count > 0 && (
                              <span className="text-muted-foreground">
                                {" "}
                                • {booking.infants_count} رضع
                              </span>
                            )}
                          </div>
                        </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span>
                          {booking.service_fees} {booking.currency}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span>العمولة</span>
                        <span>
                          {booking.commission} {booking.currency}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center justify-between font-bold">
                        <span>المجموع</span>
                        <span>
                          {booking.price + booking.service_fees} {booking.currency}
                        </span>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex items-start space-x-4 space-x-reverse">
                  <Avatar className="h-16 w-16">
                    <AvatarImage
                      src={booking.guest?.avatar_url || "/placeholder-user.jpg"}
                      alt={`${booking.guest?.first_name || ""} ${booking.guest?.last_name || ""}`}
                    />
                    <AvatarFallback>
                      {booking.guest?.first_name?.charAt(0) || "G"}
                    </AvatarFallback>
                  </Avatar>
            ...
            <TabsContent value="host" className="space-y-4 py-4">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex items-start space-x-4 space-x-reverse">
                  <Avatar className="h-16 w-16">
                    <AvatarImage
                      src={booking.host?.avatar_url || "/placeholder-user.jpg"}
                      alt={`${booking.host?.first_name || ""} ${booking.host?.last_name || ""}`}
                    />
                    <AvatarFallback>
                      {booking.host?.first_name?.charAt(0) || "H"}
                    </AvatarFallback>
                  </Avatar>
                  <div className="flex-1 space-y-1">
                    <div className="flex items-center justify-between">
                    ...
                    {booking.host?.phone_number && (
                      <p className="text-sm text-muted-foreground">
                        {booking.host.country_code} {booking.host.phone_number}
                      </p>
                    )}
                  </div>
                </div>
