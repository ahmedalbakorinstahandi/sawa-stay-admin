  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => !isLoading && onOpenChange(isOpen)}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{category ? "تعديل تصنيف" : "إضافة تصنيف جديد"}</DialogTitle>
          <DialogDescription>
            {category ? "قم بتعديل بيانات التصنيف أدناه" : "قم بإدخال بيانات التصنيف الجديد"}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>اسم التصنيف الذي سيظهر للمستخدمين</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>اسم التصنيف باللغة الإنجليزية</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>وصف موجز للتصنيف باللغة الإنجليزية</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>هل التصنيف مفعل ومرئي للمستخدمين؟</FormDescription>
                  </div>
                  <FormControl>
