...
import { Download, FileBarChart, RefreshCw, Users, Home, Calendar, TrendingUp, AlertCircle } from "lucide-react"
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          مرحباً بك في لوحة تحكم Syria Go، هنا يمكنك متابعة جميع الإحصائيات والبيانات المهمة.
        </p>
      </div>
        ...
        <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
              <Card className="lg:col-span-4 hover:shadow-md transition-shadow">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>إحصائيات الحجوزات والإيرادات للشهر الحالي</CardDescription>
                </CardHeader>
                <CardContent>
                  <Overview />
                </CardContent>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
              <Card className="lg:col-span-4 hover:shadow-md transition-shadow">
                ...
                <CardFooter className="border-t pt-4 flex justify-between">
                  <p className="text-sm text-muted-foreground">تم تحديث البيانات منذ 5 دقائق</p>
              ...
              <Card className="lg:col-span-3 hover:shadow-md transition-shadow">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>نشاط المستخدمين خلال الأسبوع الماضي</CardDescription>
                </CardHeader>
                <CardContent>
                  <UserActivity />
                </CardContent>
                <CardFooter className="border-t pt-4 flex justify-between">
                  <p className="text-sm text-muted-foreground">تم تحديث البيانات منذ 10 دقائق</p>
                  <Button variant="ghost" size="sm" className="h-8">
                    تفاصيل أكثر
                  </Button>
                </CardFooter>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <div className="grid gap-6 md:grid-cols-3">
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>عدد المستخدمين النشطين خلال الشهر الحالي</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>عدد الإعلانات الجديدة خلال الشهر الحالي</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>عدد الحجوزات الجديدة خلال الشهر الحالي</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                ...
                <div className="space-y-8">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm text-muted-foreground">12,546</span>
                    </div>
              ...
              <CardFooter className="border-t pt-4 flex justify-between">
                <p className="text-sm text-muted-foreground">تم تحديث البيانات منذ 3 ساعات</p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>تقارير مفصلة عن إيرادات المنصة</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm font-medium">تقرير الإيرادات الشهري</span>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="mr-2 h-4 w-4 rounded-full bg-primary" />
                        <span className="text-sm font-medium">تقرير الإيرادات الربع سنوي</span>
                      </div>
                      <Button variant="outline" size="sm">
                        عرض
                      </Button>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="mr-2 h-4 w-4 rounded-full bg-primary" />
                        <span className="text-sm font-medium">تقرير الإيرادات السنوي</span>
                      </div>
                      <Button variant="outline" size="sm">
                        عرض
                      </Button>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="mr-2 h-4 w-4 rounded-full bg-primary" />
                        <span className="text-sm font-medium">تقرير نشاط المستخدمين</span>
                      </div>
                      <Button variant="outline" size="sm">
                        عرض
                      </Button>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="mr-2 h-4 w-4 rounded-full bg-primary" />
                        <span className="text-sm font-medium">تقرير الإعلانات النشطة</span>
                      </div>
                      <Button variant="outline" size="sm">
                        عرض
                      </Button>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="mr-2 h-4 w-4 rounded-full bg-primary" />
                        <span className="text-sm font-medium">تقرير الحجوزات المكتملة</span>
                      </div>
                      <Button variant="outline" size="sm">
                        عرض
                      </Button>
