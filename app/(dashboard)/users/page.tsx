...
import { Edit, Eye, MoreHorizontal, Plus, Search, Trash2, UserCheck, UserX } from "lucide-react"
                  ...
                  {loading ? (
                    ...
                    users.map((user) => (
                      <TableRow key={user.id}>
                        <TableCell className="font-medium">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              {user.email_verified && <span className="text-xs text-muted-foreground">موثق</span>}
                            </div>
                          </div>
                        </TableCell>
                        ...
                        <TableCell>{new Date(user.created_at).toLocaleDateString("ar-SY")}</TableCell>
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              {user.status !== "banned" && (
                                <DropdownMenuItem onClick={() => handleUpdateUserStatus(user, "banned")}>
